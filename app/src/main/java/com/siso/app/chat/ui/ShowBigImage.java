...
import com.siso.app.chat.task.LoadLocalBigImgTask;
import com.siso.app.chat.utils.ImageCache;
import com.siso.app.chat.widget.photoview.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.ic_avatar);
